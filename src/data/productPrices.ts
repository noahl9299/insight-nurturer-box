...
const productData: Record<number, ProductData> = {
  ...
  3: { price: 22.99, rating: 4.5, reviews: 1843, size: "50L x 50B x 15D cm", material: "Plüsch, Polyester" },
  ...
  6: { price: 19.99, rating: 4.5, reviews: 2910, size: "50L x 50B x 18D cm", material: "Plüsch, PP-Füllung" },
